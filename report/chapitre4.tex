...
Dans les cas où le délai est jugé anormal, on introduit ce qu'o appelle la \textit{déviation}. Cette métrique caractérise l'anomalie. Elle est calculée différemment dans les cas où le délai est anormal.
