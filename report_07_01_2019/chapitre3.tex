...
Il existe de nombreuses API permettant d'utiliser les fonctionnalités du Spark. A savoir, il y a Java, Python, Scala et R. Nous avons utilisé Scala  dans l'implémentation exposée dans la section \ref{implementation-scala}. 
