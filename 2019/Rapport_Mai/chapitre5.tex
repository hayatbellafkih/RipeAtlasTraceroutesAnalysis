...
Le Tableau \ref{clusters-description} décrit les clusters créés au sein .  Il reprend l'ID du cluster, le nombre d'instances formant le cluster; le \textit{driver} et zéro ou plusieurs \textit{executors}, le type de l'instance et enfin le temps total de l'analyse. Le temps de l'analyse est calculé de la même façon  que le mode local. 
