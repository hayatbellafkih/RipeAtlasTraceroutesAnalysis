...
Dans ce chapitre, nous avons décrit l'implémentation de l'outil de détection en utilisant trois technologies différentes dédiées à la manipulation des données massives.  C'est la reproduction de l'outil implémenté en MongoDB.
