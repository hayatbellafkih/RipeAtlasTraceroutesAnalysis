...
\section{Implémentation avec Amazon S3 e Athena} \label{implementation-athena}
...
La Figure \ref{fig:sqlrequestathena} montre  un exemple d'une  requête SQL dans Athena. 
