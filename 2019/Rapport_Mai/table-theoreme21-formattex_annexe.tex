\chapter{Table des intervalles de confiance} \label{tables-confidence-intervalle}
\begin{table} 
	\centering
	\caption{Quantile $ q=50\% $, Confidence Levels $\gamma =95\%$}
\resizebox{!}{.40\paperheight}{%
	\begin{tabular}{|c|c|c|c|} \hline 
		n&j&k&p \\ \hline \hline 
		\multicolumn{4}{|c|}{n $\leq$5: no confidence interval possible} \\ \hline
	6&1&6&0.969 \\  \hline 
	7&1&7&0.984 \\  \hline 
	8&1&7&0.961 \\  \hline	
    9&2&8&0.961 \\  \hline 
