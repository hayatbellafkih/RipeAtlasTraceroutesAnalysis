...
Voir l'implémentation de référence : \url{https://github.com/InternetHealthReport/tartiflette}.
...
Voir README.md dans l'implémentation de référence.
\paragraph{Configurer l'analyse}
Il faut mettre à jour le fichier de configuration de l'analyse  disponible 

sur : https://github.com/InternetHealthReport/tartiflette/blob/master/analysis/conf/getRttData.conf
