...
allrttss=[rtt1, rtt9,rtt10, rtt17 ,rtt20,rtt25, rtt24,rtt5,rtt5,rtt5,rtt5,rtt5]
allrtts=[
...
def generateTraceroutes(traceroute="traceroute2.json"):
    print "debut "
    result= open('result22.json', 'w')
